...
class JobScorer:
    ...
    def __init__(self, config_path: str = "config.yaml"):
        ...
        self.weights = self.config.get(
            "scoring",
            {"salary": 0.30, "benefits": 0.20, "work_env": 0.15, "career_growth": 0.25},
        )
    ...
    def score_job(self, job: Dict) -> float:
        ...
        career_growth_score = self._score_career_growth(
            job.get("career_growth", "moderate")
        )
    ...
    def _score_work_env(self, env: str) -> float:
        ...
        env_scores = {"remote": 1.0, "hybrid": 0.8, "flexible": 0.7, "office": 0.5}
